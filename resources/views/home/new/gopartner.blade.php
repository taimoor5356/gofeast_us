            ...
            <div class="row section-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title section-title-center">
                        ...
                        <h1 class="wow fadeInUp" data-wow-delay="0.2s" data-cursor="-opaque"><span>Empowering</span> Stores and Restaurants</h1> 
                        <p>Increase Your Revenues and Reduce Your Costs A Complete AI Driven Digital Solution</p>
                    </div>
                    <!-- Section Title End -->
                </div>
            </div>
