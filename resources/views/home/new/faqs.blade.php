                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-title section-title-center">
                        ...
                        <div class="hero-btn wow fadeInUp" data-wow-delay="0.4s">
                            <a href="#" class="btn-default btn-highlighted btn-sm">Contact Us</a>
            ...
            <div class="row">
                    ...
                    <div class="page-faqs-catagery">
                        <div class="page-single-faqs page-faq-accordion" id="faq_1">
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Go<span>Feast</span></h2>
                            </div>

                            <div class="service-list wow fadeInUp mb-4" data-wow-delay="0.6s">
                                <ul>
                                    <li>Customers</li>
                                    <li>Orders</li>
                                    <li>Driver</li>
                            ...
                            <div class="faq-accordion" id="accordion">
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1">
                                            1. How does GoFeast work for customers?
                                        </button>
                                    </h2>
                                    <div id="collapse1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Customers can browse restaurants, place orders, and track deliveries in real-time through the GoFeast app.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2">
                                            2. How are orders managed?
                                        </button>
                                    </h2>
                                    <div id="collapse2" class="accordion-collapse collapse show" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Orders are processed instantly and managed through a centralized dashboard for efficiency.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3">
                                            3. How do drivers receive deliveries?
                                        </button>
                                    </h2>
                                    <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Drivers get instant delivery requests via the GoDriver app with navigation support.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4">
                                            4. Can partners track performance?
                                        </button>
                                    </h2>
                                    <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Yes, partners get detailed analytics including sales, orders, and customer insights.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    ...
                                    <div id="collapse5" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Yes, GoFeast ensures secure payments, user data protection, and safe transactions.</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="page-faqs-catagery">
                        <div class="page-single-faqs page-faq-accordion" id="faq_1">
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">GoFeast <span>Token</span></h2>
                            </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6">
                                            1. What is GoFeast Token?
                                        </button>
                                    </h2>
                                    <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#accordion1">
                                        <div class="accordion-body">
                                            <p>GoFeast Token is a digital asset used for rewards, payments, and ecosystem benefits.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse7">
                                            2. How can users earn tokens?
                                        </button>
                                    </h2>
                                    <div id="collapse7" class="accordion-collapse collapse show" data-bs-parent="#accordion1">
                                        <div class="accordion-body">
                                            <p>Users earn tokens through orders, referrals, and platform engagement.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse8">
                                            3. Where can tokens be used?
                                        </button>
                                    </h2>
                                    <div id="collapse8" class="accordion-collapse collapse" data-bs-parent="#accordion1">
                                        <div class="accordion-body">
                                            <p>Tokens can be used for discounts, payments, and future platform services.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse9">
                                            4. Is the token secure?
                                        </button>
                                    </h2>
                                    <div id="collapse9" class="accordion-collapse collapse" data-bs-parent="#accordion1">
                                        <div class="accordion-body">
                                            <p>Yes, it is built on secure blockchain technology ensuring transparency and safety.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse10">
                                            5. Can tokens be withdrawn?
                                        </button>
                                    </h2>
                                    <div id="collapse10" class="accordion-collapse collapse" data-bs-parent="#accordion1">
                                        <div class="accordion-body">
                                            <p>Yes, users can withdraw or exchange tokens based on platform policies.</p>
                                        </div>
                                    </div>
                                </div>
